...
<form action="{{ route('student.change.pass', $student->id) }}" method="POST" enctype="multipart/form-data">
    {{ method_field('put') }}
    {{ csrf_field() }}

        <!--begin::Modal-->
        <div class="modal fade" tabindex="-1" id="update_password-student-{{$student->id}}">
