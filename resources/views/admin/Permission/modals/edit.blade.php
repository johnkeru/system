...
<div class="modal fade" id="update_{{$permission->id}}" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <!--end::Notice-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="permission" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="{{$permission->name}}" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
