@foreach ($docs as $doc)
<form action="{{ route('adviser-approved', $doc->id) }}" method="post" enctype="multipart/form-data">
    {{ method_field('put') }}
    {{ csrf_field() }}

    <!-- Add Signature Upload Field -->
    
    <!-- Delete Modal -->
    <div class="modal fade" tabindex="-1" id="adviserApproved-{{$doc->id}}">
