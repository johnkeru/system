                        ...
                        @foreach ($docs as $doc)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a type="button" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="modal" data-bs-target="#pdf_{{$doc->id}}">
                                    ...
                                    @if ($doc->status_id == 1)
                                         {{-- @can('update worship') --}}
                                         <a type="button" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="modal" data-bs-target="#update_{{$doc->id}}">
                                    ...
                                    {{-- @endcan --}}
                                    {{-- @can('delete worship') --}}
                                    <a class="btn btn-icon btn-active-light-primary w-30px h-30px" href="#" data-bs-toggle="modal" data-bs-target="#delete_{{$doc->id}}">
                                    ...
                                    @role('adviser')
                                    @if($doc->status_id == '1')
                                    <a class="btn btn-icon btn-active-light-primary w-30px h-30px" href="#" data-bs-toggle="modal" data-bs-target="#adviserApproved-{{$doc->id}}">
                                        <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Communication/Clipboard-check.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <g fill=none>
                                                <rect x="0" y="0" width="24" height="24"/>
                                    ...
                                    <a class="btn btn-icon btn-active-light-primary w-30px h-30px" href="#" data-bs-toggle="modal" data-bs-target="#dissaproved-{{$doc->id}}">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Navigation/Close.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g transform="translate(12.000000, 12.000000) rotate(-45.000000) translate(-12.000000, -12.000000) translate(4.000000, 4.000000)" fill="#FF0000">
                                    ...
                                    @role('super-admin')
                                    @if($doc->status_id == '3')
                                    <a class="btn btn-icon btn-active-light-primary w-30px h-30px" href="#" data-bs-toggle="modal" data-bs-target="#osasApproved-{{$doc->id}}">
                                        <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Communication/Clipboard-check.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <g fill=none>
                                                <rect x="0" y="0" width="24" height="24"/>
                                    ...
                                    <a class="btn btn-icon btn-active-light-primary w-30px h-30px" href="#" data-bs-toggle="modal" data-bs-target="#osasDissaproved-{{$doc->id}}">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Navigation/Close.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g transform="translate(12.000000, 12.000000) rotate(-45.000000) translate(-12.000000, -12.000000) translate(4.000000, 4.000000)" fill="#FF0000">
                                                    <rect x="0" y="7" width="16" height="2" rx="1"/>
